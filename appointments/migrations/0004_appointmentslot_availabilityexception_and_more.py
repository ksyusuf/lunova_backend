...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('appointments', '0003_appointment_is_deleted'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['expert', 'date'], name='appointment_expert__dc6eb1_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['expert', 'date'], name='appointment_expert__6a581f_idx')],
